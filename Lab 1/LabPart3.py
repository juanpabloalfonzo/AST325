# -*- coding: utf-8 -*-
"""
Created on Wed Sep 25 16:49:29 2019
...
data_small=pd.read_excel (r'C:\Users\juanp\Documents\U of T\3rd Year\AST325\Lab 1\DataSmall.xlsx')
#Select specific column of spreadsheet
ds=data_small['Data']
data_large=pd.read_excel (r'C:\Users\juanp\Documents\U of T\3rd Year\AST325\Lab 1\DataLarge.xlsx')
#Select specific column of spreadsheet
dl=data_large['Data']
...
while p < 100:
    ...
    S.append(135*((lm**(p+1)/fact)*np.exp(-(lm))))
    p=p+1
#create the poission distrinution using list S
plt.plot(S)
#setting a range for our x axis to our area of interest
plt.xlim(xmin=10, xmax=41)
#create a while loop to calculate Gaussian curve
#create an empty set G to put outputs of the Gaussain function
G=[]
g=0
